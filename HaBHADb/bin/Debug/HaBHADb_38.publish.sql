...
GO
PRINT N'Creating Table [dbo].[AppImages]...';
...
GO
PRINT N'Creating Index [dbo].[AppImages].[IX_AppImages_BoardinghouseId]...';
...
GO
PRINT N'Creating Index [dbo].[AppImages].[IX_AppImages_UserId]...';
...
GO
PRINT N'Creating Foreign Key [dbo].[FK_AppImages_BoardingHouses]...';


GO
ALTER TABLE [dbo].[AppImages] WITH NOCHECK
    ADD CONSTRAINT [FK_AppImages_BoardingHouses] FOREIGN KEY ([BoardinghouseId]) REFERENCES [dbo].[BoardingHouses] ([BoardinghouseId]) ON DELETE CASCADE;
...
GO
ALTER TABLE [dbo].[AppImages] WITH NOCHECK
    ADD CONSTRAINT [FK_AppImages_AspNetUsers] FOREIGN KEY ([UserId]) REFERENCES [dbo].[AspNetUsers] ([Id]) ON DELETE SET NULL;
...
GO
ALTER TABLE [dbo].[AppImages] WITH CHECK CHECK CONSTRAINT [FK_AppImages_BoardingHouses];
