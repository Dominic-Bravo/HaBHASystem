...
@dso_cache = dso_local local_unnamed_addr global [1002 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 4323246155780009161, ; hash 0x3bff41791fd72cc9, from name: aot-HaBHADbMauiApp
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 5137820472215766460, ; hash 0x474d347f862685bc, from name: libaot-HaBHADbMauiApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HaBHADbMauiApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 266
	...
	%struct.DSOCacheEntry {
		i64 9314380031250050062, ; hash 0x81435349e9a6ac0e, from name: aot-HaBHADbMauiApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HaBHADbMauiApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 486
	...
	%struct.DSOCacheEntry {
		i64 12854393673938618003, ; hash 0xb263faf0e223c693, from name: HaBHADbMauiApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HaBHADbMauiApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 683
	...
	%struct.DSOCacheEntry {
		i64 13389581387593747367, ; hash 0xb9d15954bab50ba7, from name: HaBHADbMauiApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HaBHADbMauiApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 708
	...
	%struct.DSOCacheEntry {
		i64 14261967518775609403, ; hash 0xc5ecafe52ac7883b, from name: libaot-HaBHADbMauiApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HaBHADbMauiApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 760
